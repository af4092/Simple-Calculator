...
public class Optimization extends JFrame {
	...
	public Optimization() {
		setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\FAbdu\\Downloads\\print_calculator.png"));
		setTitle("Mini Calculator");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 360, 337);
		...
		tfNumber.setBounds(10, 33, 324, 35);
		...
		btnEqual.setForeground(SystemColor.desktop);
		...
		btnEqual.setBounds(220, 246, 114, 40);
		...
		btnClear.setBounds(72, 246, 52, 40);
		...
		btnOne.setBackground(SystemColor.activeCaption);
		...
		btnThree.setBackground(SystemColor.activeCaption);
		...
		btnFour.setBackground(SystemColor.activeCaption);
		btnFour.setBounds(154, 146, 52, 40);
		...
		btnFive.setBackground(SystemColor.activeCaption);
		btnFive.setBounds(220, 146, 52, 40);
		...
		btnSix.setBackground(SystemColor.activeCaption);
		btnSix.setBounds(282, 146, 52, 40);
		...
		btnSeven.setBackground(SystemColor.activeCaption);
		btnSeven.setBounds(154, 196, 52, 40);
		...
		btnEight.setBackground(SystemColor.activeCaption);
		btnEight.setBounds(220, 196, 52, 40);
		...
		btnNine.setBackground(SystemColor.activeCaption);
		btnNine.setBounds(282, 196, 52, 40);
		...
		btnZero.setBounds(154, 246, 52, 40);
